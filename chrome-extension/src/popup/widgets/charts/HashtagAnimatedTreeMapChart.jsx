/*import './HashtagAnimatedTreeMapChart.css'*/
...
export default class HashtagAnimatedTreeMapChart extends React.Component{
        ...
        <div>
        	...
        	<div>
					  <div class="alert alert-secondary d-flex align-items-center py-1 fst-italic small shadow-sm" role="alert">
						  ...
						  <div>
						    The numbers displayed below represent the attention got by all the posts in which these hashtags mentionned (in seconds)
							</div>
						</div>
					</div>
