      ...
      <>
        ...
        { this.props.objects != null && this.props.objects.length != 0 && 
                <div class="list-group m-1 shadow-sm small">
                  {
                    this.props.objects.map((bookmark) => (<a href={"index.html?redirect_to=ProfileView&data=" + bookmark.url} target="_blank" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
