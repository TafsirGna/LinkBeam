...
function BackToPrev(props) {
  ...
  return (
    <>
    	<div class="clearfix" title={"Back" + (props.prevPageTitle == "Activity" ? "" : " to " + props.prevPageTitle)}>
        <Link to={"/index.html" + (props.prevPageTitle == "Activity" ? "?origin=inside" : "/" + props.prevPageTitle)}>
