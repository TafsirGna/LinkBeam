...
export default class WebUiSectionMenu extends React.Component{
  ...
  handleModalShow(){
    ...
    var modalContainer = document.getElementById(appParams.extShadowHostId).shadowRoot.getElementById(appParams.modalContainerID);
      ...
      <>
        ...
        <div id={appParams.sectionMarkerID} class={"hidden w-full inline-flex p-4 mb-4 py-1 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800 "} role="alert">
          ...
          <div class="flex ml-auto">
            <button onClick={() => {this.handleModalShow()}} type="button" class="text-white bg-blue-800 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
